                ...
                },
                {
                    ...
                    template: function(row) {
                        return'<div class="btn-group">' +
                            '<a class="btn btn-sm btn-outline-info text-info " href="/admin/brand/edit/'+ row.id +'/' + row.name + '" style="cursor: pointer" data-delete-id="' + row.id + '">ویرایش</a>' +
                            '<a class="btn btn-sm btn-outline-danger text-danger brand_id"  style="cursor: pointer" data-delete-id="' + row.id + '">حذف</a>' +
                            '</div>' ;
                    }
                }]
        });
        datatable.on('click','.brand_id', function () {
