	...
	$.fn[pluginName].defaults = {
		...
		layout: {
			...
			icons: {
				...
				rowDetail: {expand: 'fa fa-chevron-down', collapse: 'fa fa-chevron-up'},
			},
		},
				...
				pagination: {
					items: {
						default: {
							...
							more: 'صفحات بیشتر',
							input: 'شماره صفحه',
							select: 'تعداد سطرها را انتخاب کنید',
							all: 'همه',
						},
	...
	defaults = {
		layout: {
			icons: {
				...
				rowDetail: {collapse: 'fa fa-chevron-down', expand: 'fa fa-chevron-up'},
			}
		}
	}
}
